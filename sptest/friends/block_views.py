...
class BlockView(APIView):
    ...
    @swagger_auto_schema(
        operation_description="Issue #05 - As a user, I need an API to block to updates from an email address",
        request_body=RequestorTargetRequestSerializer,
        responses={
            200: "Returns a JSON message with success: True ",
        ...
        if not request.data:
            ...
            if result_status == status.HTTP_200_OK:
                ...
                if not requestor:
                    ...
                    requestor.blocks.connect(target)
