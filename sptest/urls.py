...
from sptest.friends import friends_views, subscribe_views, block_views, social_update_views
...
urlpatterns = [
    ...
    url(r'^social_updates/$', social_update_views.SocialUpdateView.as_view()),
